...
export const BannerImageHotspot = () => {
  return (
		<>
			...
			<div
				class="w-100 h-100 bg-img-cover bg-pos-center-center hotspot-container py-5 py-md-7 py-lg-10"
            ...
            "contentTarget": "#hotspot-one"
				...
				></div>
				<div
					class="container py-lg-8 position-relative z-index-10 d-flex align-items-center"
					data-aos="fade-left"
				>
					<div class="py-8 d-flex justify-content-end align-items-start align-items-lg-end flex-column col-lg-4 text-lg-end">
						...
						<a class="text-decoration-none fw-bolder" href="#">
				...
				<div id="hotspot-one" class="d-none">
					<div class="m-n2 rounded overflow-hidden">
						...
						<div class="px-4 py-4 text-center">
							...
							<a href="/product" class="fw-bolder text-link-border pb-1 fs-6">
